...
const moviesArr = [
  ...
  },
  {
    ...
    ticketPrice: 380,
    posterURL:
      "https://www.kuwaittimes.com/wp-content/uploads/2022/07/E77F81B6-3BA3-4761-8EFD-E163BC347DBC.jpeg",
  },
  {
    title: "Attorney Woo",
    year: 2022,
    ...
    bookTickets[i].addEventListener("click", function () {
      for (let j = 0; j < moviesArr.length; j++) {
        if (i === j) {
          ...
          <h2 class="fw-bold mt-2">${title} (${year})</h2>
